...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    // ResizeObserver — keeps canvas pixel-perfect with container
    const ro = new ResizeObserver((entries) => {
      for (const entry of entries) {
        ...
        gl.viewport(0, 0, sizeRef.current.w, sizeRef.current.h)
      }
    })
    ...
    const render = () => {
      ...
      if (locs.u_resolution) ctx.uniform2f(locs.u_resolution, w, h)
